...
export function BookPage() {
  ...
  const [allLines, setAllLines] = useState<{ id: string; userId: string; userName: string; quote: string; page: number; feeling?: string; createdAt?: string; echoCount?: number }[]>([]);
      ...
      <div>
        {loading ? (
          ...
          <div className="content-fade-in">
            {lines.map((l, i) => (
              <div key={i} className="cmpitm" onClick={() => navigate(`/line/${l.id}`)}>
